        ...
        if (challanTable) {
            ...
            rows.forEach(row => {
                ...
                cells.forEach(cell => {
                    ...
                    if (cell.textContent.trim().match(/^\$|PKR|Rs\.|\d+\.\d{2}|\d+,\d+/)) {
                        cell.classList.add(
                            "!font-semibold",
                            "!text-emerald-400"
                        );
            ...
            const infoPanel = element.querySelector("td[style*='border-right:solid 1px']");
            if (infoPanel) {
                ...
                links.forEach(link => {
                    link.classList.add("!text-blue-400", "!underline", "!hover:text-blue-300");
                });
            ...
            if (portletBody) {
                ...
                const paymentInstructionsCell = element.querySelector("td[style*='border-right:solid 1px']");
                if (paymentInstructionsCell) {
                    ...
                    for (const td of allTds) {
                        if (td.textContent.includes("Fee can be paid using any one of the following methods")) {
                            td.remove();
                            break;
                        }
                    }
