...
const Modal = ({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[10001] flex items-center justify-center p-4">
      ...
      {}
      <div
        className={`relative w-full ${maxWidth} bg-[#0c0c0c] border border-white/10 rounded-[2.5rem] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 flex flex-col max-h-[90vh]`}
      >
        {}
