(function (global, factory) {
    ...
    ReadableStreamDefaultReader.prototype.read = function () {
      ...
      var readRequest = {
        ...
        _closeSteps: function () {
          return resolvePromise({ value: undefined, done: true });
        },
  ...
  var WritableStream = (function () {
    function WritableStream(rawUnderlyingSink, rawStrategy) {
      ...
      var underlyingSink = convertUnderlyingSink(
        rawUnderlyingSink,
        "First parameter",
      );
  ...
  function WritableStreamFinishErroring(stream) {
    ...
    var promise = stream._writableStreamController[AbortSteps](
  ...
  var DOMException$1 = isDOMExceptionConstructor(NativeDOMException)
    ? NativeDOMException
  ...
  function ReadableStreamPipeTo(
    ...
    return newPromise(function (resolve, reject) {
      ...
      if (
        ...
        var destClosed_1 = new TypeError(
  ...
  var ReadableStream = (function () {
    function ReadableStream(rawUnderlyingSource, rawStrategy) {
      ...
      var strategy = convertQueuingStrategy(rawStrategy, "Second parameter");
      var underlyingSource = convertUnderlyingDefaultOrByteSource(
        rawUnderlyingSource,
        "First parameter",
      );
    ...
    ReadableStream.prototype.pipeThrough = function (rawTransform, rawOptions) {
      ...
      var transform = convertReadableWritablePair(
        rawTransform,
        "First parameter",
      );
  ...
  var TransformStream = (function () {
    function TransformStream(
      ...
      var writableStrategy = convertQueuingStrategy(
        rawWritableStrategy,
        "Second parameter",
      );
      var readableStrategy = convertQueuingStrategy(
        rawReadableStrategy,
        "Third parameter",
      );
